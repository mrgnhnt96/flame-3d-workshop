  ...
  Widget build(BuildContext context) {
    ...
    return FlutterDeckApp(
      ...
      slides: [
        ...
        Slide03PassiveVSActiveRendering(),
        Slide04FlameGameLoop(),
        Slide05FlameComponents(),
        Slides.title('3D Rendering Concepts'),
        Slide06WhatIs3D(),
        Slide07ThreeDimensionalAxes(),
        Slide08ThreeDimensionalProjections(),
        Slide09Matrices(),
        Slide10Glossary(),
        Slide11ClassStructure(),
        Slide12FirstCube(),
        Slide13Meshes(),
        Slide14TheCamera(),
        Slide15BirthTheCamera(),
        Slide16CameraTypes(),
        Slide17Models(),
        Slide18Animations(),
        Slide19Playground(),
